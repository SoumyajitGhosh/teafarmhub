...
;
const metadata = {
    title: "TeaLeaf - Premium Tea Plantation",
    description: "Discover authentic tea from our sustainable tea plantation. Experience the finest tea varieties sourced directly from our farms.",
    generator: "v0.app",
    icons: {
        icon: [
            {
